...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomtitle=1mm, bottomrule=.15mm, colback=white, toptitle=1mm, breakable, opacitybacktitle=0.6, arc=.35mm, leftrule=.75mm, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black, left=2mm, toprule=.15mm, titlerule=0mm]
