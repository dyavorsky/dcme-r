...
To emphasize this point, page 2 of the preface to @train2009 indicates that "Whenever appropriate, researchers should use availabale codes rather than writing their own. However, the true value of the new approach to choice modeling is the ability to create tailor-made models. The computation and programming steps that are needed to implement a new model are usually not difficult. An imporatant goal of the book is to teach these skills as an integral part of the exposition of the models themselves." Then @train2009 exposits 286 additional pages on choice modeling without providing a single line of code. I am almost univerally enthusiastic, positive, and supportive about Train's book, but this is the one area where the book falls short.[^2] What is "not that difficult" for Train is immensely difficult for a typical graduate student. The aim of this book is to ease that difficulty.
...
[^2]: Train provides Matlab code on his website. In addition, there is some pseudo-code on page 5. But most often, the reader gets a treatment similar to that on page 84: "Computer routines are available in commercial software packages for estimating nested models by maximum likelihood. Hensher and Greene (2002) provide a guide for nested logits using available software." This simply does not achieve the important goal to teach computation and programming skills as an integral part of the choice models.
...
Unquestionably, my deepest thanks go to Alison, Zach, and Ben for their patience.
